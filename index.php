        ...
        <div class="container-fluid p-0">
            ...
            <section class="resume-section" id="about">
                <div class="resume-section-content">
                    <h1 class="mb-0">
                        Mr. Mamadou
                        <span class="text-danger">Barry</span>
                    </h1>
                    <div class="subheading mb-5">
                        Front Street · Fouta Community, Contanct# · (+231) 775240880 ·
                        <a href="mailto:name@email.com" >mb388205@gmail.com</a>
                    </div>
                    <p class="lead mb-5">I am experienced in information technology to provide a quality education in information communication technology (ICT) for bachelor degree.</p>
            ...
            <section class="resume-section" id="education">
                <div class="resume-section-content">
                    ...
                    <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                        <div class="flex-grow-1">
                            <h3 class="mb-0">Starz University</h3>
                    ...
                    <div class="d-flex flex-column flex-md-row justify-content-between">
                        <div class="flex-grow-1">
                            <h3 class="mb-0">Elizabeth Crawford Memorial High School</h3>
                            <div class="sub mb-3">Diaploma Program</div>
                            <p>GPA: 3.56</p>
                        </div>
                        <div class="flex-shrink-0"><span class="text-primary"> May 2006</span></div>
                    </div>
                </div>
            </section>
            <hr class="m-0" />
